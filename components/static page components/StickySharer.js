...
const StickySharer = ({url}) => {
  ...
  return (
      ...
      <ul>
        ...
        {/* <li>
          <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${url}`} target={'_blank'}>
            ...
            <li>
          <a >
            <img src="/copy.png" onClick={()=>{clickHandle()}} alt="linkedin" />
            <span>Linbked in</span>
          </a>
        </li>
      </ul>
    ...
    {
      msg &&
      <div className="position-fixed bottom-0 end-0  bg-light" style={{zIndex: 11,boxShadow:'0 0 10px 1px rgba(0,0,0,0.5)'}}>
